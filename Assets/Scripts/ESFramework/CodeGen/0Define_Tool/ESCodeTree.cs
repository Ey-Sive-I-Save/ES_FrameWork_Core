...
namespace ES
{
    ...
    public class ESCodeTreeTarget : ESCodeNode_Standard, IESCodeTreeClass
    {
       ...
       ," static ES.EnumCollect"};
        ...
        {
            string content = KeyValueMatchingUtility.SimpleScriptMaker.
            ...
            string back = KeyValueMatchingUtility.SimpleScriptMaker.CreateScriptBounds
            ...
            KeyValueMatchingUtility.SafeEditor.PingAssetByPath(Path.Combine(folderPath, nameCache));
        }
    ...
    public abstract class ESCodeNode_Standard : IESCodeTreeNode
    {
        ...
        [LabelText("预览"), DisplayAsString(TextAlignment.Left, Overflow = false), HideLabel, GUIColor("@KeyValueMatchingUtility.ColorSelector.Color_02")] public string preview = "";
    ...
    public class ESCodeTree_Class : PointerPackerBase<string, IESCodeTreeClass, ESCodeTreeTarget, ESCodeRune, IESCodeTreeNode>, IESCodeTreeClass
    {
        ...
        public override string Pick(IESCodeTreeClass on = null, ESCodeTreeTarget from = null, ESCodeRune with = null)
        {
            ...
            string back = KeyValueMatchingUtility.SimpleScriptMaker.CreateClassContentByString(
    ...
    public class ESCodeNode_Method : ESCodeNode_Standard
    {
        ...
        public override string Pick(IESCodeTreeClass on = null, ESCodeTreeTarget from = null, ESCodeRune with = null)
        {
            ...
            string back = KeyValueMatchingUtility.SimpleScriptMaker.CreateMethod(
    ...
    public class ESCodeNode_Field : ESCodeNode_Standard
    {
        ...
        {
            string typeName = typeAndInit?.Pick(this, on, "AAA") ?? "int";
            string back = KeyValueMatchingUtility.SimpleScriptMaker.CreateFieldContent(
                typeName: typeName,
    ...
    public class ESCodeNode_Define_Define_ : ESCodeNode_Standard
    {
        ...
        {
            string typeName = typeAndInit?.Pick(this, on, "AAA") ?? "int";
            string back = KeyValueMatchingUtility.SimpleScriptMaker.CreateParaOrDefineContent(
                typeName: typeName,
