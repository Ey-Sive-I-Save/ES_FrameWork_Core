...
namespace ES
{
    public static partial class KeyValueMatchingUtility
    {
        ...
        public class ScriptMaker
        {
            ...
            public static void CreateScriptEasy(string Folderpath, string className, string parent = ":MonoBehaviour", string Attribute = "", string nameSpace = "ES")
            {
...
";
            ...
            public static void CreateScriptNormal(string Folderpath, string className, string beforeClassName = "", string insideClass = "", string parent = ":MonoBehaviour", string Attribute = "", string nameSpace = "ES", string using_ = "")
            {
                if (string.IsNullOrEmpty(className))
                {
                    Debug.LogError("类名不可为空!");
                ...
                string fullPath = Path.Combine(Folderpath, HandleString_ToValidName(className).Replace(" ", "") + ".cs");
