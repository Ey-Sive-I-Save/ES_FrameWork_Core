...
namespace ES
{
    ...
    public class ESCode_EnumSource : SerializedScriptableObject
    {
        ...
        [LabelText("全部枚举"), GUIColor("@KeyValueMatchingUtility.ColorSelector.Color_03"),]
        ...
        public void Generate()
        {
            ...
            foreach (var type in EnumTypes)
            {
                ...
                {
                    int Now = 0;
                    allContent += KeyValueMatchingUtility.SimpleScriptMaker.CreateNotes($"枚举类型名:{type.EnumTypeName},枚举中文名{type.EnumChineseName}");
                    if (type.IsFlag)
                    {
                        allContent += $"[Flags]\n";
                    }
            ...
            KeyValueMatchingUtility.SimpleScriptMaker.CreateScriptBounds(path_, "EnumDefineSort_" + EnumSortName_ + ".cs",
              using_: "using ES;\r\nusing Sirenix.OdinInspector;\r\nusing System;\r\nusing System.Collections;\r\nusing System.Collections.Generic;\r\nusing UnityEngine;",
              content: allContent
                 , TruelyCreate: true);
        }
        ...
        public class EnumType
        {
            ...
            [LabelText("是Flag的"), GUIColor("@KeyValueMatchingUtility.ColorSelector.Color_04")] public bool IsFlag = false;
            [FoldoutGroup("枚举类"), GUIColor("@KeyValueMatchingUtility.ColorSelector.Color_04")]
            ...
            [FoldoutGroup("枚举类")][LabelText("全部元素"), GUIColor("@KeyValueMatchingUtility.ColorSelector.ColorForESValue")] public List<OneEnumElement> All = new List<OneEnumElement>();
            ...
            {
                if (EDIT)
                    EDIT = KeyValueMatchingUtility.SafeEditor.DisplayDialog("开启强制修改", "这只能修改枚举源代码的内容，不会影响已经有的引用，可能造成大范围的Error", "继续", "算了");
            }
        }
