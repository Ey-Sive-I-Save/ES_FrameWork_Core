...
namespace ES
{
    public interface IESUIDomain : IESHosting
    {
    ...
    public interface IESUIDomain<Core_> : IESUIDomain
    {
        //给Module抽象定义用
        Core_ Core { get; }
    ...
    [Serializable]
    public abstract class ESUIDomain_Original<Core_, Module_> : IESHosting<Module_>, IESUIDomain<Core_> where Core_ : ESUICore_Original where Module_ : class, IESUIModule, IESModule
    {
        #region 总重要信息
