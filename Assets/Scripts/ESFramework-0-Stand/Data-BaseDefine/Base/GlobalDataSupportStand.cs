...
namespace ES.GlobalDataStand
{
    
    //有最优先的加载权限
    [DefaultExecutionOrder(-10)]
    /*作为全局数据替代场景单例来获取编辑器时数据*/
    public class GlobalDataSupportStand<This> : GlobalSerializedScriptableObject where This : GlobalDataSupportStand<This>
    {
        #region 单例声明
...
#endif
    [Serializable]
    public class GlobalDataReferStand<This> : ESReferAbstract<This> where This : GlobalDataSupportStand<This>                                                                                                                
    {
        public override This HandleIfNull()
        {
            return GlobalDataSupportStand<This>.Instance;
        }
    }
}
