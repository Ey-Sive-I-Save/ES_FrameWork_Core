...
namespace ES
{
    ...
    public class StateMachineDomainForEntity : Domain<Entity, StateMachineModuleForDomainForEntity>,IWithESMachine
    {
        ...
        public override void AwakeRegisterAllModules()
        {
            ...
            ESStaticLogicUtility.DataApply.ApplyStatePackToMachine(RegisterPack, StateMachine);
   ...
   /* [Serializable, TypeRegistryItem("技能注册器")]
    public class ModuleStateMachine_SkillRegister : StateMachineModuleForDomainForEntity
    {
        [LabelText("注册技能的Info")]
        ...
        public override bool _TryStartWithHost(StateMachineDomainForEntity hosting)
        {
            ...
            foreach (var i in skillDataInfos)
            {
                ...
                var Create = ESStaticUtility.Creator.CreateStateRunTimeLogicComplete(skillsSequence.bindingStateInfo);
    ...
    public class ModuleStateMachine_CrashDodge : StateMachineModuleForDomainForEntity
    {
        ...
        public struct Applyable_CrashDodge
        {
            ...
            [LabelText("向量处理模式")] public EnumCollect.TransformHandleSpaceWithTarget vectorHandle;
            [LabelText("路径处理模式")] public EnumCollect.ToDestinationPathType pathType;
        ...
        protected override void CreateRelationshipOnly()
        {
            ...
            if (dataInfo != null)
            {
                var Create = ESStaticLogicUtility.Creator.CreateStateRunTimeLogicComplete(dataInfo);
    ...
    public class ModuleStateMachine_SlowAction : StateMachineModuleForDomainForEntity
    {

    }
    [Serializable, TypeRegistryItem("Buff注册器")]
    public class ModuleStateMachine_BuffRefister : StateMachineModuleForDomainForEntity
    {
        /*[LabelText("注册技能的Info")]
        public List<SkillRegisterMessage> skillDataInfos = new List<SkillRegisterMessage>();
        private Dictionary<string, EntityState_Skill> Skills = new Dictionary<string, EntityState_Skill>();
        ...
        public override bool _TryStartWithHost(StateMachineDomainForEntity hosting)
        {
            ...
            var Create = ESStaticLogicUtility.Creator.CreateStateRunTimeLogicComplete(info.bindingState);
    ...
    public class TestModule2 : StateMachineModuleForDomainForEntity
    {
    }
}
