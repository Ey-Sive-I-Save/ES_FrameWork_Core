...
namespace ES
{
    ...
    public abstract class BaseESNanoState<Key_> : BaseESModule<BaseOriginalStateMachine>,IESNanoState
    {
        ...
        public void SetKey(object _key)
        {
            ...
            {
                this.key = ESStaticDesignUtility.Matcher.SystemObjectToT<Key_>(_key);
            }
        }
    ...
    public abstract class ESNanoStateWithDelegate<Key_> : BaseESNanoStateWithDelegate<Key_, ESNanoStateWithDelegate<Key_>>
    {
    ...
    public abstract class ESNanoStateWithDelegate_StringKey: BaseESNanoStateWithDelegate<string, ESNanoStateWithDelegate_StringKey>
    {
        public override string QuickKey()
        {
            return key;
