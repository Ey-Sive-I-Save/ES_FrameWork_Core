...
namespace ES
{
    public class SkillPointRunTime : MonoBehaviour
    {
      ...
      /*  private ArchitectureKeyValuePoolTypeListIOC_OBSULUTE _ioc;*/
        SkillControllerSourceCore_OB _core;
        ...
        void ApplyArchitectureKeyValuePool(SkillControllerSourceCore_OB core)
        {
            _core = core;
...
/*es update*/
        ...
        private void OnDrawGizmos()
        {
            ...
            Handles.Label(transform.position, bindingInfo?.key.str_direc+"LV " + currentLevel+"\n 状态 : "+ESStaticDesignUtility.Matcher.EnumToString_SkillPointState(levelStates_[currentLevel]), GameCenterManager.Instance.style);
