...
namespace ES {
    public interface IESUIModule : IESModule
    {
    ...
    public abstract class ESUIModule_Orignal<Core_, Domain_> : BaseESModule<Domain_>, IESUIModule where Core_ : ESUICore_Original where Domain_ : class, IESUIDomain<Core_>
    {
        ...
        *  启用时(从禁用到启用进行--和脚本几乎一致)
        ...
        #region 预设相关
#if UNITY_EDITOR
        [ValueDropdown("Editor_AllPresets"), LabelText("选择预设", SdfIconType.CaretDownSquareFill), SerializeField,HideInInspector, InlineButton("_TrySetupPresetModule", "使用该预设"), GUIColor("@ESStaticDesignUtility.ColorSelector.Color_01")]
