...
namespace ES
{
    ...
    public class SkillPointDataInfo : SoDataInfo
    {
        ...
        {
            [Space(25)]
            [LabelText("显示名称",SdfIconType.Alarm),GUIColor("@ESDesignUtility.ColorSelector.Color_03"), PropertyOrder(-1)] public string displayName = "技能点-";
...
*/
            ...
            [InlineProperty(LabelWidth = 50), LabelText("状态图标"), TabGroup("<->精灵图配置", TextColor = "@ESDesignUtility.ColorSelector.Color_04"), OdinSerialize,NonSerialized]public SkillPointSprites sprites = new SkillPointSprites();
