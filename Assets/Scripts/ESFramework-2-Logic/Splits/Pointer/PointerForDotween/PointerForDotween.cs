...
using UnityEngine;
using static ES.Pointer.PointerForIPointerForTween_MakeSequence_PackerSelectSome;
...
namespace ES.Pointer
{
    ...
    {
        [LabelText("空间")]
        public EnumCollect.TransformHandle_ValueReleSpace space;
        ...
        protected override Tween PickTruely(Transform by = null, object yarn = null, object on = null)
        {
            ...
            if (space == EnumCollect.TransformHandle_ValueReleSpace.WorldSpace)
            {
