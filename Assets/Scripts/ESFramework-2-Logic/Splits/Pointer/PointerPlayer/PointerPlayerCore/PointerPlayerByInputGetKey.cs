...
namespace ES
{
    ...
    public class PointerPlayerByInputGetKey : PointerPlayer,IPointerForBoolCaster
    {
        ...
        [LabelText("发起投射?", SdfIconType.At), GUIColor("@ESDesignUtility.ColorSelector.Color_04")] public bool usePlayerCaster;
        [LabelText("发送到Caster", SdfIconType.At), ShowIf("usePlayerCaster"), GUIColor("@ESDesignUtility.ColorSelector.Color_04")] public PointerPlayerSystemObjectCaster playerCaster_;
